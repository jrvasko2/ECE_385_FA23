...
typedef struct {
    ...
    struct SdkData* currentSDK;   /**< Current SDK version*/
} ArducamCamera;
...
//!
//! @param  camera ArducamCamera instance
//! @param  val `1` turn on automatic white balance `0` turn off automatic white
//! balance
//!
//! @return Return operation status
//!
...
//! address, Byte 2 indicates the high octet of the register, Byte 3 indicates
//! the low octet of the register, and Byte 4 indicates the value written to the
//! register
//!
//**********************************************
...
//**********************************************
//!
//! @brief Inform the other party of camera status
//!
//! @param camera ArducamCamera instance
//!
...
//initializes the SPI, ripped from 6.2
void SPI_Init();
